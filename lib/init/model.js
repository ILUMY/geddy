...
module.exports = new (function () {
  ...
  this.init = function (app,callback){
    self.loadModels(app,'',callback);
  }

  this.loadModels = function (app, moduleName, callback) {
    var modelRoute = moduleName == ''?'app/models':'app/modules/'+moduleName+'/models';

    var modelDir = path.join(modelRoute)
      , cwd = process.cwd()
    ...
    utils.mixin(model, {loadModels:this.loadModels});
